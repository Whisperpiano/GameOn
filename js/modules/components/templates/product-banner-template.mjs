...
export function productPanelTemplate(id, title, description, genre, released, ageRating, price, discountedPrice, onSale, image, platforms ) {
...
function createProductPageSlider() {
    ...
    const images = document.querySelectorAll('#small-picture-1, #small-picture-2, #small-picture-3, #small-picture-4');
